...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Runner local para benchmark TMLAP con SHOA")
...
def main() -> None:
    ...
    benchmark = root / "benchmarks" / "run_tmlap_shoa_puro_benchmark.py"
    profiles = root / "benchmarks" / "run_tmlap_shoa_puro_profiles_matrix.py"
