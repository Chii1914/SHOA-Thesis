...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Runner local para benchmark TMLAP con PSO")
...
def main() -> None:
    ...
    benchmark = root / "benchmarks" / "run_tmlap_pso_benchmark.py"
    profiles = root / "benchmarks" / "run_tmlap_pso_profiles_matrix.py"
