"""Run a profile matrix for PSO benchmark on CEC2022."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Lanza benchmark PSO en CEC2022 para perfiles soft/medium/hard"
    )
    parser.add_argument(
        "--config",
        default="pso_cec2022_profiles_config.json",
        help="Ruta del archivo de configuracion JSON",
    )
    parser.add_argument(
        "--benchmark-script",
        default="run_cec2022_pso_benchmark.py",
