"""Run a profile matrix for SHO + LIME benchmark on TMLAP instances."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Lanza benchmark SHO+LIME en TMLAP para perfiles soft/medium/hard"
    )
    parser.add_argument(
        "--config",
        default="sholime_tmlap_profiles_config.json",
        help="Ruta del archivo de configuracion JSON",
    )
    parser.add_argument(
        "--benchmark-script",
        default="run_tmlap_sholime_benchmark.py",
