"""Run a profile matrix for SHOA pure benchmark on TMLAP instances."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Lanza benchmark SHOA puro en TMLAP para perfiles soft/medium/hard"
    )
    parser.add_argument(
        "--config",
        default="shoa_puro_tmlap_profiles_config.json",
        help="Ruta del archivo de configuracion JSON",
    )
    parser.add_argument(
        "--benchmark-script",
        default="run_tmlap_shoa_puro_benchmark.py",
